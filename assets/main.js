...
(function () {
  ...
  const I18N = {
    ja: {
      ...
      "roadmap.newmd.t": "新規 md をすぐ付箋化",
      "roadmap.newmd.d": "トレイの右クリックから新しい md を作って、そのまま付箋に。",
    ...
    en: {
      ...
      "roadmap.newmd.t": "Create a sticky md",
      "roadmap.newmd.d": "Make a new md right from the tray's right-click menu and stick it.",
